    ...
    <section className="bg-gray-50 py-16">
      <div className="container mx-auto px-4">
        ...
        <div className="flex justify-between items-center mb-10 flex-wrap gap-4">
          <div>
            <p className="text-indigo-600 font-semibold text-sm">OUR BLOG</p>
            <h2 className="text-3xl md:text-4xl font-bold mt-2">
              Our Latest Blog
            </h2>
          </div>
          <button className="flex items-center gap-2 bg-indigo-600 text-white px-5 py-2 rounded-full shadow hover:bg-indigo-700 transition">
            ...
            >
              ...
              {blog.image ? (
                <div className="relative mb-4 aspect-[4/3] overflow-hidden rounded-xl">
                  ...
                  />
                  {blog.date && (
                    <span className="absolute top-2 left-2 bg-white text-indigo-600 text-sm font-semibold px-3 py-1 rounded shadow">
                      {blog.date}
                    </span>
                  )}
                </div>
              ) : (
                <div className="mb-4 bg-gray-200 h-48 flex items-center justify-center rounded-xl text-gray-500">
                  No Image
                </div>
              )}
              ...
              {/* Title */}
              <h3 className="text-lg font-semibold text-gray-900 mb-4 hover:text-indigo-600 transition cursor-pointer">
                {blog.title}
              </h3>
