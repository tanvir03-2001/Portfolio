    ...
    <section className="bg-gray-100 py-20 px-4">
      <div className="container mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <div>
          ...
          <h2 className="text-3xl font-bold mb-4">Lets Know About Me</h2>
          <p className="text-gray-600 mb-6 max-w-md">
            It is a long established fact that a reader will be distracted by
            the moreable content of a page when looking at its layout. The point
            of using Loremsam Ipsum is that it has a more-or-less normal
            distribution.
          </p>
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <div className="w-full bg-gray-300 h-2 rounded">
                <div className="bg-indigo-600 h-2 rounded w-[90%]"></div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="w-full bg-gray-300 h-2 rounded">
                <div className="bg-indigo-600 h-2 rounded w-[70%]"></div>
              </div>
            </div>
          </div>
          ...
          {/* View More Button */}
          <button className="mt-6 bg-white text-indigo-600 px-5 py-2 rounded-md shadow hover:bg-indigo-50 transition">
            View More
          </button>
        </div>
      </div>
